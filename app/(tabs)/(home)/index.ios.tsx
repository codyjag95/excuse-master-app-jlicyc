...
import { StyleSheet, View, Text, TouchableOpacity, ScrollView, useColorScheme, Pressable, ActivityIndicator } from "react-native";
...
export default function HomeScreen() {
  ...
  const handleRateExcuse = async (rating: number) => {
    ...
    console.log('Rating excuse (iOS):', rating);
